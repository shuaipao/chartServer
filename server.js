...
function scoreName({scoreName = "appscore"}, conditions) {
    return (conditions.scoreName == scoreName) || 0
}

//isNew:
function isNew({isNew = 'All'}, conditions) {
    return (conditions.isNew == 'All' || conditions.isNew == isNew) || 0
}
...
function productName({productName = '全部'}, conditions) {
    ...
    return (conditions.productName.indexOf("全部") > -1 || conditions.productName.indexOf(productName) > -1) || 0
}
...
function channelId({channelId = "0"}, conditions) {
    ...
    return (conditions.channelId.indexOf("0") > -1 || conditions.channelId.indexOf(channelId) > -1) || 0
}
